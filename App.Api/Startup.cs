...
namespace App.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            );                                                  //vai puxar o arquivo json

            services.AddCors();
            services.AddOptions();

            Persistense.DependencyInjectionConfig.Inject(services); //Cuidar com a escrita do Dependency
            Application.DependencyInjectionConfig.Inject(services); //E do inject, se forem diferentes
            Infrasctructure.DependencyInjectionConfig.Inject(services);//do arquivo referenciado
        }
